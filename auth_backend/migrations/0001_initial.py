        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.CharField(
                        blank=True, max_length=40, null=True, verbose_name="Company"
                    ),
                ),
                (
                    "position",
                    models.CharField(
                        blank=True, max_length=40, null=True, verbose_name="Position"
                    ),
                ),
                (
                    "type",
            ...
            managers=[("objects", auth_backend.models.UserManager()),],
        ),
        migrations.CreateModel(
            name="Contact",
            fields=[
                ...
                (
                    "house",
                    models.CharField(blank=True, max_length=35, verbose_name="House"),
                ),
                (
                    "apartment",
                    models.CharField(blank=True, max_length=15, verbose_name="Flat"),
                ),
                (
                    "e_mail",
                    models.EmailField(blank=True, max_length=50, verbose_name="E-mail"),
                ),
                ("phone", models.CharField(max_length=35, verbose_name="Cell Phone")),
                (
                    "work_phone",
                    models.CharField(
                        blank=True, max_length=40, verbose_name="Working Phone"
                    ),
                ),
                (
                    "user",
